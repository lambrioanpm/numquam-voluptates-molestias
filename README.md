...
```ruby
pod '@lambrioanpm/numquam-voluptates-molestias', :path => '../node_modules/@lambrioanpm/numquam-voluptates-molestias'
```
...
```groovy
include ':@lambrioanpm/numquam-voluptates-molestias'
project(':@lambrioanpm/numquam-voluptates-molestias').projectDir = new File(rootProject.projectDir, '../node_modules/@lambrioanpm/numquam-voluptates-molestias/android')
```
...
dependencies {
   ...
   implementation project(':@lambrioanpm/numquam-voluptates-molestias')
}
```
